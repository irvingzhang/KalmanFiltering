...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	int index = m_wndStatusBar.CommandToIndex(IDS_TIMER);//获取IDS_TIMER的索引值
...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
    ...
    cs.lpszName="Nonlinear Filtering (基于BOT模型)";//设置程序的标题    
	return TRUE;
}
...
//{
//	CRect rect;
//	int index = m_wndStatusBar.CommandToIndex(IDS_PROGRESS);//获取IDS_PROGRESS的索引值
